...
The actual script is [runGATK.sh](runGATK.sh)

The script and all its steps are documented in detail in this page: [GATK_Script_Readme.md](GATK_Script_Readme.md)
